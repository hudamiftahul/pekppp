    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
                ...
                <div class="alert-text">Form Evaluator penilaian kepatuhan penyelenggaraan pelayanan publik perangkat daerah.
                    <br />
            ...
            <div class="card card-custom">
                ...
                <!--begin::Card body-->
                <div class="card-body">
                    <form action="<?= base_url(); ?>evaluator/store" method="post">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="vertical-align : middle;text-align:center;">
                                                        <?php if (in_array(pertanyaanev($inp['id'])['nama_pertanyaan'], check())) : ?>
                                                            <?php if (jawaban($this->session->userdata('opd_id'), date('Y')) != NULL) : ?>
                                                                <?= jawaban($this->session->userdata('opd_id'), date('Y'))[pertanyaanev($inp['id'])['nama_pertanyaan']] ?>
                                                            <?php else : ?>
                                                                <?= ''; ?>
                                                            <?php endif; ?>
                                                        <?php else : ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="vertical-align : middle;text-align:center;">
                                                        <?php if (in_array(pertanyaanev($proc['id'])['nama_pertanyaan'], check())) : ?>
                                                            <?= jawaban($this->session->userdata('opd_id'), date('Y'))[pertanyaanev($proc['id'])['nama_pertanyaan']] ?>
                                                        <?php else : ?>
                                                            <b class="justify-content-center">-</b>
                                                        <?php endif; ?>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="vertical-align : middle;text-align:center;">
                                                        <?php if (in_array(pertanyaanev($out['id'])['nama_pertanyaan'], check())) : ?>
                                                            <?= jawaban($this->session->userdata('opd_id'), date('Y'))[pertanyaanev($out['id'])['nama_pertanyaan']] ?>
                                                        <?php else : ?>
                                                            <b class="justify-content-center">-</b>
                                                        <?php endif; ?>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="vertical-align : middle;text-align:center;">
                                                        <?php if (in_array(pertanyaanev($pgd['id'])['nama_pertanyaan'], check())) : ?>
                                                            <?= jawaban($this->session->userdata('opd_id'), date('Y'))[pertanyaanev($pgd['id'])['nama_pertanyaan']] ?>
                                                        <?php else : ?>
                                                            <b class="justify-content-center">-</b>
                                                        <?php endif; ?>
                                                    </td>
