...
<div class="topbar">
    ...
    <div class="dropdown">
        ...
        <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
            <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1 pulse pulse-danger">
                <span class="svg-icon svg-icon-xl svg-icon-danger">
                    <i class="far fa-bell text-danger" width="24" height="24"></i>
                </span>
            ...
            <form>
                ...
                <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(assets/media/misc/bg-1.jpg)">
                    ...
                    <h4 class="d-flex flex-center rounded-top">
                        ...
                        <span class="btn btn-text btn-success btn-sm font-weight-bold btn-font-md ml-2">23 terbaru</span>
                    </h4>
                    <!--end::Title-->
                    <!--begin::Tabs-->
    ...
    <div class="topbar-item">
        <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
            ...
            <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"><?= ucfirst($this->session->userdata('username')); ?></span>
            <span class="symbol symbol-lg-35 symbol-25 symbol-light-danger">
                <span class="symbol-label font-size-h5 font-weight-bold"><?= substr(ucfirst($this->session->userdata('username')), 0, 1); ?></span>
            </span>
        </div>
    </div>
    <!--end::User-->
