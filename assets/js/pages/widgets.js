...
var KTWidgets = function () {
    ...
    var _initDashboardUser = function () {
        var element = document.getElementById("dashboardUser");
        var height = parseInt(KTUtil.css(element, 'height'));
    ...
    // dashboard chart
    var _iniNilaiEvaluasi = function () {
        var element = document.getElementById("nilai_evaluasi");
        var height = parseInt(KTUtil.css(element, 'height'));
        var nilai = $('#nilai_evaluasi').attr("data-total")
            ...
            plotOptions: {
                radialBar: {
                    ...
                    dataLabels: {
                        ...
                        value: {
                            color: KTApp.getSettings()['colors']['red']['red-400'],
                            fontSize: "30px",
                            fontWeight: '700',
                            offsetY: 12,
                            show: true,
                    ...
                    track: {
                        background: KTApp.getSettings()['colors']['red']['red-200'],
                        strokeWidth: '100'
                    }
                }
            },
            colors: [KTApp.getSettings()['colors']['red']['red-500']],
            stroke: {
                lineCap: "round",
            },
            labels: ["Progress"]
    ...
    // dashboard chart 2
    var _initNilaiValidasi = function () {
        var element = document.getElementById("nilai_validasi");
        var height = parseInt(KTUtil.css(element, 'height'));
        var nilai = $('#nilai_validasi').attr("data-total")
